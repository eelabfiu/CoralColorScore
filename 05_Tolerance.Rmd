...
##Try log transformation
hist(log(TolData_W1$Chl.prop))
shapiro.test(log(TolData_W1$Chl.prop))
#Normal

##Model as a function of Site and Genotype
##Model with log transformation
Tol_Chl_W1_lm<-lm(log(Chl.prop)~Site+Genotype+Site:Genotype, data=TolData_W1)
...
Significant effect of Genotype and Site*Genotype.
...
##Try log transformation
hist(log(TolData_M4$Chl.prop))
shapiro.test(log(TolData_M4$Chl.prop))
#Normal

##Model as a function of Site and Genotype
##Model with log transformation
Tol_Chl_M4_lm<-lm(log(Chl.prop)~Site+Genotype+Site:Genotype, data=TolData_M4)
...
Significant effect of Site and Genotype. Marginal effect (p<0.1) of Site*Genotype.
...
##Try log transformation
hist(log(TolData_M12$Chl.prop))
shapiro.test(log(TolData_M12$Chl.prop))
#Normal

##Model as a function of Site and Genotype
##Model with log transformation
Tol_Chl_M12_lm<-lm(log(Chl.prop)~Site+Genotype+Site:Genotype, data=TolData_M12)
...
Marginal (p<0.1) effect of Site. Still checking Site*Genotype for comparability across Timepoints.
...
Tol_Chl_M12_SG.plot<-ggplot(Tol_Chl_M12_SG, aes(x=Site.Geno, y=Chl.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_Chl_M12_lm.p,  y.position=0.2, step.increase=0.20, label="Sig", hide.ns=TRUE); Tol_Chl_M12_SG.plot
...
##Try log transformation
hist(log(TolData_M1$Sym.prop))
shapiro.test(log(TolData_M1$Sym.prop))
#Normal

##Model as a function of Site and Genotype
##Model with log transformation
Tol_Sym_M1_lm<-lm(log(Sym.prop)~Site+Genotype+Site:Genotype, data=TolData_M1)
...
Significant effect of Genotype. Marginal effects (p<0.1) of Site and Site * Genotype. Still checking Site*Genotype for comparability across Timepoints.
...
Tol_ScoreF_W1_SG.plot<-ggplot(Tol_ScoreF_W1_SG, aes(x=Site.Geno, y=Score_Full.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreF_W1_lm.p,  y.position=0.80, step.increase=0.15, label="Sig", hide.ns=TRUE); Tol_ScoreF_W1_SG.plot
...
Tol_ScoreF_W2_SG.plot<-ggplot(Tol_ScoreF_W2_SG, aes(x=Site.Geno, y=Score_Full.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreF_W2_lm.p,  y.position=0.79, step.increase=0.15, label="Sig", hide.ns=TRUE); Tol_ScoreF_W2_SG.plot
...
Tol_ScoreF_M1_SG.plot<-ggplot(Tol_ScoreF_M1_SG, aes(x=Site.Geno, y=Score_Full.prop, colour=Genotype)) + 
 ...
 ylim(0, 1)+ 
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreF_M1_lm.p,  y.position=0.1, step.increase=0.12, label="Sig", hide.ns=TRUE); Tol_ScoreF_M1_SG.plot
...
Tol_ScoreF_M4_SG.plot<-ggplot(Tol_ScoreF_M4_SG, aes(x=Site.Geno, y=Score_Full.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreF_M4_lm.p,  y.position=0.1, step.increase=0.12, label="Sig", hide.ns=TRUE); Tol_ScoreF_M4_SG.plot
...
Tol_ScoreF_M8_SG.plot<-ggplot(Tol_ScoreF_M8_SG, aes(x=Site.Geno, y=Score_Full.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreF_M8_lm.p,  y.position=0.65, step.increase=0.25, label="Sig", hide.ns=TRUE); Tol_ScoreF_M8_SG.plot
...
Tol_ScoreTP_W1_SG.plot<-ggplot(Tol_ScoreTP_W1_SG, aes(x=Site.Geno, y=Score_TP.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreTP_W1_lm.p,  y.position=0.45, step.increase=0.25, label="Sig", hide.ns=TRUE); Tol_ScoreTP_W1_SG.plot
...
Tol_ScoreTP_W2_SG.plot<-ggplot(Tol_ScoreTP_W2_SG, aes(x=Site.Geno, y=Score_TP.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreTP_W2_lm.p,  y.position=0.4, step.increase=0.2, label="Sig", hide.ns=TRUE); Tol_ScoreTP_W2_SG.plot
...
Tol_ScoreTP_M1_SG.plot<-ggplot(Tol_ScoreTP_M1_SG, aes(x=Site.Geno, y=Score_TP.prop, colour=Genotype)) + 
 ...
 ylim(0, 1)+ 
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreTP_M1_lm.p,  y.position=0.22, step.increase=0.15, label="Sig", hide.ns=TRUE); Tol_ScoreTP_M1_SG.plot
...
Tol_ScoreTP_M4_SG.plot<-ggplot(Tol_ScoreTP_M4_SG, aes(x=Site.Geno, y=Score_TP.prop, colour=Genotype)) + 
  ...
  scale_x_discrete(labels=c("","Klein","","","Something Special",""))+
  scale_color_manual(values = Geno.colors.o)+ 
  stat_pvalue_manual(data=Tol_ScoreTP_M4_lm.p,  y.position=0.3, step.increase=0.15, label="Sig", hide.ns=TRUE); Tol_ScoreTP_M4_SG.plot
...
Convert Estimate to the Response scale (instead of log scale) for models where the response was log transformed
```{r}
Tol_contrasts$Estimate<-Tol_contrasts$estimate

#Chl W1
Tol_contrasts$Estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="W1")]<-exp(Tol_contrasts$estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="W1")])

#Chl M4
Tol_contrasts$Estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="M4")]<-exp(Tol_contrasts$estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="M4")])

#Chl M12
Tol_contrasts$Estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="M12")]<-exp(Tol_contrasts$estimate[which(Tol_contrasts$Response=="Chlorophyll" & Tol_contrasts$TimeP=="M12")])

#Sym M1
Tol_contrasts$Estimate[which(Tol_contrasts$Response=="Symbionts" & Tol_contrasts$TimeP=="M1")]<-exp(Tol_contrasts$estimate[which(Tol_contrasts$Response=="Symbionts" & Tol_contrasts$TimeP=="M1")])
