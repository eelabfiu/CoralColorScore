...
Chl_M1.pred.plot<-ggplot(M1_Chl_predict, aes(x=Predicted, y=Measured))+
  ...
  annotate("text",  x=1.3, y=0, label=expression(bolditalic(paste(rho, "= 0.886  p < 0.001"))),size=sig.sz, hjust = 0);Chl_M1.pred.plot
...
Chl_M4.pred.plot<-ggplot(M4_Chl_predict, aes(x=Predicted, y=Measured))+
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), 
        ...
        axis.text.y=element_text(size=axis.txt.sz, colour="black"),
        plot.title = element_text(size = plot.title.sz, colour="black", hjust = 0.5))+
  annotate("text",  x=1, y=0, label=expression(bolditalic(paste(rho, "= 0.680  p < 0.001"))),size=sig.sz, hjust = 0);Chl_M4.pred.plot
...
Sym_M1.pred.plot<-ggplot(M1_Sym_predict, aes(x=Predicted, y=Measured))+
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), 
        ...
        axis.text.y=element_text(size=axis.txt.sz, colour="black"),
        plot.title = element_text(size = plot.title.sz, colour="black", hjust = 0.5))+
   annotate("text",  x=0.6, y=0, label=expression(bolditalic(paste(rho, "= 0.754  p < 0.001"))),size=sig.sz, hjust = 0);Sym_M1.pred.plot
...
Sym_M4.pred.plot<-ggplot(M4_Sym_predict, aes(x=Predicted, y=Measured))+
 ...
 xlim(0, 1)+
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), 
        ...
        axis.text.y=element_text(size=axis.txt.sz, colour="black"),
        plot.title = element_text(size = plot.title.sz, colour="black", hjust = 0.5))+
   annotate("text",  x=0.5, y=0, label=expression(bolditalic(paste(rho, "= 0.345  p < 0.05"))),size=sig.sz, hjust = 0);Sym_M4.pred.plot
