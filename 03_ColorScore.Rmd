...
Color.LDA.PCA_LD1.plot_fig1<-Color.LDA.PCA_LD1.plot+theme(legend.position="none")+ggtitle("Color Score LDA-PCA")
...
##Save Figure
ggsave(filename="Figures/FigureS1_Color_Score_LDA.png", plot=Color_Score_LDA_fig, dpi=300, width=10, height=8, units="in")
